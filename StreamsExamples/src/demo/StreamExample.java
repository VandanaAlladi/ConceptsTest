...
public class StreamExample {
	...
	public static void main(String[] args) {
		...
		List<Integer> descendingOrderNumbers = streamOFArray1.sorted(Comparator.reverseOrder())
				.collect(Collectors.toList());

		System.out.println(descendingOrderNumbers);
		System.out.println("******************************************************");
		// peek is used to print intermediate result of the stream which is getting
		// processed
		List<Integer> numbers = Arrays.asList(1, 3, 5, 6, 7, 7, 8, 8, 9);
		List<Integer> numbers1 = numbers.stream().filter((Integer s) -> (s > 3))
				.peek((Integer s) -> System.out.println(s)).collect(Collectors.toList());
		System.out.println("******************************************************");
		...
		List<Integer> numbers7 = Arrays.asList(1, 3, 5, 6, 7, 7, 8, 8, 9);
		
		List<Integer> desendingOrderList = numbers7.stream()
		.map((Integer val)-> (-1*val))
		.sorted()
		.peek((Integer val)->System.out.println("Peek: "+val))
		.map((Integer val)->(-1*val)).collect(Collectors.toList());
		System.out.println(desendingOrderList);
