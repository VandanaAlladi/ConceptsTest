...
public class RemoveElementsFromCart extends AbstractComponents {
	...
	public AmazonSearch cartCount() throws InterruptedException {
		...
		List<WebElement> productsInCart1=getProductsList();
		deleteCart(productsInCart1.size());
	...
	public List<WebElement> getProductsList() {
		...
		public void  deleteCart(int j) throws InterruptedException {
			...
			System.out.println("products1 size:"+j);
