...
public class StandAloneModifying {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//loginPage.goTo();
		PasswordPage passwordPage=loginPage.loginUserName(phoneNo);
		
		RemoveElementsFromCart removeElementsFromCart=passwordPage.enterPassword(passWordInput);
		
		AmazonSearch amazonSearch=removeElementsFromCart.cartCount();
		
		//List<WebElement> cartProducts=removeElementsFromCart.getProductsList();
		//removeElementsFromCart.deleteCart();
		//AmazonSearch amazonSearch=new AmazonSearch(driver);
		
		
		
		//List<WebElement>productsFound=amazonSearch.findProducts();
		ProceedToCart proceedToCart=amazonSearch.searchforProducts(productName);
		//ProceedToCart proceedToCart=new ProceedToCart(driver);
		AddressPage addressPage=	proceedToCart.proceedToBuy();
		//AddressPage addressPage=new AddressPage(driver);
		addressPage.getAddress();
